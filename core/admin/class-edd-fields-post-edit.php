	...
	public function fields( $post ) {
		...
		<div class="edd-fields-meta-box">
			...
			foreach ( $templates as $template ) {
				...
				$templates_select[ EDDFIELDS()->utility->sanitize_key( $template['label'] ) ] = $template['label'];
			...
			<?php foreach ( $templates as $template ) : ?>
				...
				<div id="edd-fields-<?php echo EDDFIELDS()->utility->sanitize_key( $template['label'] ); ?>" class="edd-fields-template<?php echo ( $active_template !== EDDFIELDS()->utility->sanitize_key( $template['label'] ) ) ? ' hidden' : ''; ?>">
